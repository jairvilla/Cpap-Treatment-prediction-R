...
pkgs <-   c("dplyr", "tidyr", "caret","xtable","data.table", "lubridate","ROCR","broom", 
            ...
            "compareGroups","ggpubr","pROC", "glmnet","ROCR") 

sapply(pkgs, require, character.only = T)

#............................................................
# Load and save data----
save.image(file="run19.RData")
save.image(file="run20.RData")
load(file = "run20.RData")

# ...........................................................
# Load and explore the data set  ----
# Initial dataset1: All features....................
# Cpap1 contains the features and information clinical patients from dataset  
cpap1  <- cpap5 
str(cpap1)
dim(cpap3)
names(cpap3)
...
#.............................................
# Pre-processing data ----
# Dataset contains 58 numerical variables and 15 categorical Var.
# and 1 outcome (numerical or binary) related to CPAP use.
## Convert chr variables to factor

cpap3       <- as.data.frame(unclass(cpap3))
cpap3$class <- as.factor(ifelse(cpap3$cpap1 >= 4, 1, 0))#Outcome Var.
cpap_num    <- dplyr::select(cpap3, 1:58)               #Selecting num. Var. 
cpap4       <- cbind(cpap_num, class1=cpap3$class)
cpap4$class1<- as.factor(ifelse(cpap4$class1 =="1","adherent","non-adherent")) 

cpap5       <- dplyr::select(cpap3, 59:74)              #Selecting Cat. Var.
cpap5$class1<- as.factor(ifelse(cpap5$cpap1 >= 4, 1, 0))# Threshold > 4 hours
cpap5$class1 <- as.factor(ifelse(cpap_cat$class== 1 ,"adherent", "non-adherent"))
str(cpap4)

# Re-level variables 
cpap4$class1 <- relevel(cpap4$class, ref="1")  # Reorder levels of factor, ref = 1 then we estime the probability of fealure.

#.....................................................
# Statistical Analysis
# Compare two groups (adherents vs non-adhrents)
# using t-test and Wilcoxon test
# compute count mean an sd of one numerical variable
...
# Dataset: cpap3_copy
## This dataset constains non-redundant varaibles,standarize categorical varaibles as factor
## cpap as binary data.
...
# dataset3: features selected from features selection techniques
cpap3 <- cbind(cpap_sig, enf_resp=cpap1$enf_respira_A)
str(cpap3)


# Run 18 features without higthly correlated features
names(cpap1)
summary(cpap1)
